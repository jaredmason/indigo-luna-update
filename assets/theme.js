...
document.addEventListener('obsidian:upsell:updated', (evt) => {
  window.Spruce.store('cartCount').count = evt.detail.count
});
...
Spruce.watch('drawer.sizeGuideDrawerOpen', function (value) {
  var drawer = document.querySelector('[data-size-guide-drawer]');
  var drawerToggle = store.sizeGuideOpener;
  toggleDrawer(drawer, drawerToggle, value);
});
...
Spruce.watch('drawer.supportDrawerOpen', function (value) {
  var drawer = document.querySelector('[data-support-drawer]');
  var drawerToggle = document.querySelector('[data-support-drawer-toggle]');
  toggleDrawer(drawer, drawerToggle, value);
});
...
document.addEventListener('keyup', function (event) {
  ...
  if (store.supportDrawerOpen) Spruce.store('drawer').supportDrawerOpen = false;
  ...
  if (store.sizeGuideDrawerOpen) Spruce.store('drawer').sizeGuideDrawerOpen = false;
...
function toggleDrawer(drawer, drawerToggle, isOpen) {
  ...
  document.documentElement.classList.add('is-faded');
  setTimeout(function () {
    trapFocus(drawer);
  ...
  document.documentElement.classList.remove('is-faded');
  siblings.forEach(function (sibling) {
...
register('sidebar', {
 ...
 register('sidebar_support', {
   ...
   onSelect: function onSelect() {
   Spruce.store('drawer').supportDrawerOpen = true;
   },
   onDeselect: function onDeselect() {
   Spruce.store('drawer').supportDrawerOpen = false;
   },
...
register('product', {
  ...
  if (this.slides && this.slideList && this.slides.getAttribute('data-slideshow-enabled')) {
    ...
    this.slideshowSettings = {
      ...
      classes: {
        // Add classes for pagination.
        pagination: 'splide__pagination splide__pagination--product flex justify-start items-center mt-4 ml-4 w-auto lg:ml-8' // container
      },
      breakpoints: {
          1024: {
          type: 'loop',
...
register('collection', {
  ...
  window['ThemeSection_collection'] = function () {
    ...
    mounted: function mounted() {
      ...
      document.addEventListener('keyup', function (event) {
      if (event.key === 'Escape') {
       if (_this.filtersOpen_1) {
         _this.filtersOpen_1 = false;

         _this.$refs.filter_1.focus();
         }

         if (_this.filtersOpen_2) {
         _this.filtersOpen_2 = false;

         _this.$refs.filter_2.focus();
         }
      ...
      section.container.addEventListener('baseline:collection:open-filters', function () {
        _this.filtersOpen_1 = true;
      });
      section.container.addEventListener('baseline:collection:open-filters', function () {
        _this.filtersOpen_2 = true;
      });
...
register('size-guide-drawer', {
  onLoad: function onLoad() {
  window['ThemeSection_sizeGuideDrawer'] = function () {
    return {
    };
  };
  },
  onSelect: function onSelect() {
  Spruce.store('drawer').sizeGuideDrawerOpen = true;
  },
  onDeselect: function onDeselect() {
  Spruce.store('drawer').sizeGuideDrawerOpen = false;
  },
